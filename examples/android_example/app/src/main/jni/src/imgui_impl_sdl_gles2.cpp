...
int32_t get_density()
{
	...
	jmethodID getAssetsMethodId = env->GetMethodID(activityClass,
												   "getAssets", "()Landroid/content/res/AssetManager;");
	jobject jAssetManager = (jobject)env->CallObjectMethod(activity, getAssetsMethodId);
